...
Act as if you are searching the live web (Chrome/ChatGPT style) to find deep insights about "{{{productName}}}" (Category: {{{category}}}).
...
4. **SEO & Visibility**: Provide exactly 15 highly-searched keywords and SEO tags separated by commas.
...
CRITICAL: Do not give short, generic answers. Every section must meet the word count requirements exactly.`,
});
